...
if (FileExist("Models", "UsersListJSON.json") != true){
  try{
    ...
    let users = [new newPerson("Rickert",
        ...
        "Jeremy Jonker", "test.studenten@gmail.com", "Yasmine172", "Good Idea! Everyone, gather around so I can call out Peralta in front of you.", "Student", "U2"),
        ...
        "Vage Namen", "1123912@gmail.com", "Jeremy192", "That one is the dump?", "Student", "U9"),
