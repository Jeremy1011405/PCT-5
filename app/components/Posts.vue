  ...
  goToChats() {
    try {
      if (FileExist("Models", "ChatsJSON.json") != true) {
        let newMessage1 = new Message(
          "FirstMessage1",
          5,
          null,
          null,
          "Welkom bij de team Phidippides app!",
        ...
        let newchat = new Chat(
          ...
          AppSettings.getString("LoggedinID"),
          "Team Phidippides",
          "https://i.ibb.co/Wf0TJj3/ic-launcher.png",
          [newMessage1, newMessage2, newMessage3],
          "Welkom bij de team Phidippides app! \n heb je vragen of opmerkingen? \n Neem dan contact op met de berheerder.",
          "nu"
        );
