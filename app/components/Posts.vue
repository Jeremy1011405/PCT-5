      ...
      <StackLayout>
        ...
        >
          ...
          <GridLayout columns="1*, 7*, *" row="0" class="post-username">
            <Image col="0" :src="profilePicture(post.username)" class="post-profile-picture"> </Image>
            <Label :text="post.username" col="1"></Label>
          <!-- Remove Post Button -->
            <Image col="2" v-show="showRemove()" src="~/Images/remove_btn.png" class="post-remove-button" @tap="deletePost(post)"> </Image>
          </GridLayout>
          <!-- Image -->
...
export default class Posts extends Vue {
  ...
  beforeMount() 
  {
    ...
    { 
     ...
     // mounted voor de user: dit is nodig om posts te kunnen liken
  ...
  MakePost(args: TapGestureEventData) {
      ...
      fullscreen: true,
      props: {onAddPost: this.onAddPost}
    });
  }
